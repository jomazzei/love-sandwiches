...
def get_sales_data():
    ...
    while True:
        ...
        sales_data = input_data_str.split(",")
...
def validate_data(values):
    """
    In Try, convert all string values to integer
...
def calculate_surplus_data(sales_row):
    ...
    Surplus defined as sales figure subtracted from the stock:
...
def get_stock_values(data):
    ...
    for heading, stock_num in zip(headings, data):
        stock_dict[heading] = stock_num
        formatted_str += f"{stock_num} {heading.capitalize()}\n"
